...
var FieldText=React.createClass({
    ...
    render() {
        if (this.state.readonly) {
            ...
            return <textarea className="form-control" ref={this.input_mounted} onBlur={this.on_blur} type={this.props.password?"password":"text"} value={this.state.val_str} onChange={this.onchange} style={{width:this.props.width,height:this.props.height}}/>
        }
    },
